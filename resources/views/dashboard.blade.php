...
<div id="default-carousel" class="relative w-4/5 ml-36 pt-20 drop-shadow-2xl" data-carousel="slide">
  ...
  <div class="pt-20 pl-64">
    <a href="/informasitagihan" class="relative w-3/4 h-56 block w-sm border bg-emerald-900 border-gray-200 rounded-lg shadow-2xl hover:bg-emerald-700 text-white">
      ...
      <p class=" mt-6 ml-6 font-normal text-gray-400 flex-auto">Jika anda belum membayar iuran tagihan sampah, segera membayar di menu informasi tagihan atau tomboh dibawah ini.</p>
