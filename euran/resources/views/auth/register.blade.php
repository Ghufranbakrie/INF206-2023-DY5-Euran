<x-guest-layout>
    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="addres" value="{{ __('address') }}" />
                <x-input id="addres" class="block mt-1 w-full" type="text" name="addres" :value="old('addres')" required autofocus autocomplete="addres" />
            </div>
